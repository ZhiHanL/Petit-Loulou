var StateMain = {
  ...
  create: function() {
    ...
    owl = new Animal(5900, game.world.centerY + 50, 50,'owl', 'owl', 'owlSpeech', 'speechButton', 'https://petitloulou.com/collections/baby-mobile/products/baby-musical-owl-mobile', 'https://petitloulou.com/pages/monster-photo-gallery', 'yetiFamily', 56, 258, 290, 327);
    bear = new Animal(game.world.centerX + 2100, game.world.centerY, 100,'bear', 'bear', 'bearSpeech', 'speechButton', 'https://petitloulou.com/products/milo-the-raccoon-pillow', 'https://petitloulou.com/pages/monster-photo-gallery', null, 133, 149, 210, 226);
    raccoon = new Animal(6800, game.world.centerY + 50, 150,'raccoon', 'raccoon', 'raccoonSpeech', 'speechButton', 'https://petitloulou.com/products/milo-the-raccoon-pillow', 'https://petitloulou.com/pages/monster-photo-gallery', 'yetiFamily', 294, 324, 340, 384);
    ...
    //gray = new Animal(6000, game.world.centerY + 60, 0,'gray', 'gray', 'graySpeech', 'speechButton', 'https://petitloulou.com/collections/monsters/products/make-your-own-monster-a-diy-plush-monster-kit-green', 'https://petitloulou.com/pages/monster-photo-gallery', 'yetiFamily', 100, 150, 198, 223);
