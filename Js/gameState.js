var StateMain = {
  ...
  create: function() {
    ...
    gray = new Animal(1800, game.world.centerY +20, 0,'gray', 'gray', 'graySpeech', 'speechButton', 'https://petitloulou.com/collections/monsters/products/make-your-own-monster-a-diy-plush-monster-kit-green', 'https://petitloulou.com/pages/monster-photo-gallery',   132, 304, 311, 338);
    ...
    raccoon = new Animal(6800, game.world.centerY + 50, 150,'raccoon', 'raccoon', 'raccoonSpeech', 'speechButton', 'https://petitloulou.com/products/milo-the-raccoon-pillow', null,  294, 324, 340, 384);
